...
\lhead{
\Large Trill\\Health System\\Joint Strength\\
\rule{\textwidth}{2pt}
}
\rhead{}
\lfoot{
{\scriptsize Patient: Redacted, MRN: -} \hfill Page \thepage \hfill {\scriptsize Pt Location: Trill Health System}

\rule{\textwidth}{1pt}

\parbox{4cm}{\small Verdant Valley Health, \\1234 Symbiont St, \\Capital, Trill A1B 2C3, \\T: (123) 456-7890}
\hfill
\parbox{4cm}{\small Trill Prime Hospital, \\123 Cavern Rd, \\Capital, Trill A1B 2C3, \\T: (123) 456-7890}
\hfill
\parbox{4cm}{\small Curzon Centre of Healing, \\1234 Dax St, \\Capital, Trill, A1B 2C3\\T: (123) 456-7890}
}
\rfoot{}
...
\colorbox[gray]{0.8}{\parbox{\textwidth}{
  \begin{tabular}{p{.2\textwidth} p{.3\textwidth} p{.2\textwidth} p{.3\textwidth}}
    ...
    {\bf D.O.B.}: & 21/5/1941 & {\bf Legal Sex}: & Male \\
    {\bf MRN}: & - & {\bf Family Doctor}: & -\\
    {\bf Account \#}: & - & {\bf Registration Date}: & -\\
    {\bf Health Card \#}: & - & {\bf Specimen \#}: & 12A-123AB0012\\
  \end{tabular}
}}
...
\bf 12A-123AB0012 &  10/4/2024 1158 & 10/4/2024 1158 & Blood & Blood, Venous \\
\end{tabular}
...
{\bf RESULT: No pathogenic germline variants were detected:} However, a variant of uncertain significance (VUS) was detected in the PALB2 gene (see below for explanation)
...
{\bf Interpretation}: No pathogenic variants were detected in any of the genes targeted by massively parallel sequencing and deletion/duplication analysis. Although this result decreases the likelihood of hereditary cancer; it does not exclude a diagnosis of a hereditary cancer syndrome
...
{\bf HBOP1 Genes examined}: ATM, BARD1, BRCA1, BRCA2, BRIP1, CDH1, CHEK2, EPCAM (3' copy number assessment only), HOXB13 (exon 1 only), MLH1, MSH2, MSH6, PALB2, PMS2, PTEN, RAD51C, RAD51D, STK11, TP53 
...
{\bf \large Signed By}\\
Torias Dax, PhD on 10/04/24

\vspace{2em}
\rule{\textwidth}{1pt}\\
{\small Blood specimen 12A-123AB0012 from Blood, Venous Unspecified. Ordered by Torias Dax, PhD. Authorized by Torias Dax, PhD. Collected: 10/4/2024 1158, Received: 1158. Verified: 10/4/2024 1223. Resulted by Verdant Valley Health Laboratory Molecular Diagnostics.}
...
\bf \small Verdant Valley Health Laboratory - Molecular Diagnostics & \small C LAB MOLECULAR DIAGNOSTICS, 1234 Symbiont St; Capital, Trill A1B 2C3
\end{tabular}
...
\begin{center}
\scriptsize
If you have received this report in error, please return by Fax to Health Information Management at Trill Health System at 123-456-7899. If you don't have access to fax, or have other questions, please call 123-456-7890 ext. 1234
\end{center}
