...
%Golden Field Health (Girton)
\begin{document}
\parbox[t][][]{.38\textwidth}{
{\large \bf Golden Field Health | Girton General}\\
GFH Health Nexus
}
\hfill
\parbox[t][][]{.55\textwidth}{
{\large \bf Molecular Genetics Laboratory }\\
{\scriptsize 123 Sample St. Girton, AB, A1B 2C3 \\
t: 123-456-7890 x4457 f: 123-456-7899}
}

\begin{tabular}{l l l l}
Clinic ID: & REDACTED & Medical Record \#:& Redacted \\
Clinic Name: & REDACTED \& M & Last Name:& Redacted \\
Physician: & REDACTED & First, Middle:& Redacted\\
Procedure Date: & Redacted& DOB/Sex: & Redacted/Female \\
Accession Date: & Redacted & Health Card \#:&  Redacted \\
Report Date: & Redacted & Visit \#:&  Redacted \\
\end{tabular}
...
{\bf TEST DESCRIPTION}: Custom Gene Sequencing (NGS): VHL; Targeted Variant Testing: VHL, Exon 3, c.499C>T, p.(Arg167Trp)
...
{\it VHL}, NM\_000551.3 & c.499C>T, p.(Arg167Trp) & Heterozygous & Likely pathogenic \\ \hline
\end{tabular}

\paragraph{INTERPRETATION:} {\bf Positive}. Sequencing of the VHL gene identified likely pathogenic variant described above.
