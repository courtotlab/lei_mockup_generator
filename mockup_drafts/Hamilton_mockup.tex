...
{\bf Name}: {\Large JONASSON, ANDERS} & {\bf Hospital ID No.}: M002174677 \\
 & {\bf Health Care No.}: - \\
 {\bf Sex}: M \hspace{2ex} {\bf Age}: 51 \hspace{2ex} {\bf D.O.B}: 28/12/69 & {\bf Account No}.: MF017396/21 \\
 & {\bf Location}: MR-GEN \\
 {\bf Specimen No.}: {\Large 21:M09519} & {\bf Specimen Date}: 20/09/21 \hspace{2ex} {\bf Status}: SOUT\\
