...
\begin{center}{\LARGE \bf Romulan Regional Laboratory Medicine Program}\end{center}
\vspace{-2.2em}\begin{center}{\Large Regional Genetics Services of Romulus}\end{center}
...
{\bf Name}: {\Large DOE, JOHN} & {\bf Hospital ID No.}: M001234567 \\
 & {\bf Health Care No.}: - \\
 {\bf Sex}: M \hspace{2ex} {\bf Age}: 51 \hspace{2ex} {\bf D.O.B}: 28/12/69 & {\bf Account No}.: MF012345/67 \\
 & {\bf Location}: MR-GEN \\
 {\bf Specimen No.}: {\Large 12:M01234} & {\bf Specimen Date}: 20/09/21 \hspace{2ex} {\bf Status}: SOUT\\
 {\bf Requesting Physician}: REDACTED & {\bf Received Date}: 24/09/21 1425  \\
 {\bf Location}: & \\
 {\bf Specimen}: Extracted Nucleic Acid (DNA) & {\bf Printed On}: 12/11/21 1439\\
\end{tabular}
}}
...
\vspace{1em}
{\bf Summary}: This is an abnormal result A pathogenic variant was detected in the
gene.

\vspace{1em}
Sequence variant(s) identified:\\
Gene (Transcript): BRCA2 (NM\_000059.3) \\
\vspace{1em}
HGVS: c.5722\_5723delCT, p.(Leu1908ArgfsTer2) \\
Location: exon 11 \\
Zygosity: heterozygous \\
Variant type: frameshift \\
ACMG classification: pathogenic (category \#1)
}
