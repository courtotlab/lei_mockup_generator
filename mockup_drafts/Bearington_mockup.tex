...
\begin{center}{\LARGE \bf Bearington Health Centre}\end{center}
\vspace{-2.2em}\begin{center}{\Large Bearington Health Genetics Services}\end{center}
...
{\bf Name}: {\Large REDACTED, REDACTED} & {\bf Hospital ID No.}: REDACTED \\
 & {\bf Health Care No.}: - \\
 {\bf Sex}: - \hspace{2ex} {\bf Age}: - \hspace{2ex} {\bf D.O.B}: - & {\bf Account No}.: REDACTED \\
 & {\bf Location}: MR-GEN \\
