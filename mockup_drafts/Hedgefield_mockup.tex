...
%Hedgefield Health Centre (Hedgefield)
\pagestyle{fancy}
\fancyhf{}
...
\colorbox[gray]{0.8}{\parbox{\textwidth}{
  \begin{tabular}{p{.2\textwidth} p{.3\textwidth} p{.2\textwidth} p{.3\textwidth}}
    ...
    {\bf D.O.B.}: & Redacted & {\bf Legal Sex}: & Male \\
    {\bf MRN}: & - & {\bf Family Doctor}: & -\\
    {\bf Account \#}: & - & {\bf Registration Date}: & -\\
    {\bf Health Card \#}: & - & {\bf Specimen \#}: & Redacted\\
  \end{tabular}
}}
...
\bf 24C-101GMOO14 &  10/4/2024 1158 & 10/4/2024 1158 & Blood & Blood, Venous \\
\end{tabular}
...
{\bf \large Signed By}\\
REDACTED on 10/04/24

\vspace{2em}
\rule{\textwidth}{1pt}\\
{\small Blood specimen REDACTED from Blood, Venous Unspecified. Ordered by REDACTED. Authorized by REDACTED, PhD FCCMG. Collected: 10/4/2024 1158, Received: 1158. Verified: 10/4/2024 1223. Resulted by Hedgefield Health Centre Molecular Genetics Lab.}
