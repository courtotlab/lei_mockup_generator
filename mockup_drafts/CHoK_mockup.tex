...
\begin{center}{\large Mock document---Do not use as data}\hrule\end{center}


\begin{tabular}{p{2cm} >{\centering\arraybackslash}p{11.59cm} p{2cm}}
{\Huge \bf CHoK} & {\bf Genetics Diagnostic Laboratory} \newline
123 Kahless Rd, Capital, Q'onos A1B C2D \newline
(Phone) 123-345-6789 ext. 0001 $\cdot$ (Fax) 123-456-6780 & \\
\end{tabular}
...
\hrule
\begin{tabular}{p{2cm} p{5.75cm} p{2cm} p{5.75cm}}
Authorized by: & Redacted & Collected: & 15/12/2023 12:51 \\
Ordered by: & Redacted & Received: & 15/12/2023 15:09 \\
ID: & Redacted & Verified On: & 5/3/2024 17:58 \\
\end{tabular}
...
Summary of Results: {\bf Variant of uncertain clinical significance detected}
...
HEREDITARY BREAST AND OVARIAN CANCER 18 gene panel, HOXB13 c.251G>A (p.Gly84Glu) variant sequencing, and MLPA for a subset of genes 
\begin{flushright}
...
The following transcripts are used in this analysis: ATM (NM\_000051.3). BARD1 (NM\_000465.2) , BRCA1 (NM\_007294.3). BRCA2 (NM\_000059.3), BRIP1 (NM\_032043.2), CDH1 (NM\_004360.3) , CHEK2 (NM\_007194.3), EPCAM (NM\_002354.2), HOXB13 (NM\_008361.5), MLH1 (NM\_000249.3), MSH2 (NM\_000251.2), MSHG (NM\_000179 2), PALBZ (NM\_024875.3), PMS2 (NM\_000535.5) , PTEN (NM\_000314.4), RAD51C (NM\_058216.1). RAD51D (NM\_002878.3), STK11 (NM\_000455.4), and TP53 (NM\_000546.5)
