...
{\large \bf Betazed Health | Temple of Ri'ix Hospital}\\
Lwaxana and Alexander Troi Health Complex
}
\hfill
\parbox[t][][]{.55\textwidth}{
{\large \bf Pathology \& Laboratory Medicine }\\
{\scriptsize 123 Chalice Ave. Suite 1-200, Ri'ix, Betazed, UFP, A2B 3C4 \\
t: 123-456-7890 x1234 f: 123-456-7899}
}

\begin{tabular}{l l l l}
Clinic ID: & XYZ & Medical Record \#:& Redacted \\
Clinic Name: & PRENATAL DIAGNOSIS \& M & Last Name:& Redacted \\
Physician: & CRUSHER, DR BEVERLEY & First, Middle:& Redacted\\
...
Copies to: BASHIR, (GC) JULIAN \hfill {\bf Molecular Lab\#}: M24-XXXX
