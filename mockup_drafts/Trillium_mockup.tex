...
\colorbox[gray]{0.8}{\parbox{\textwidth}{
  \begin{tabular}{p{.2\textwidth} p{.3\textwidth} p{.2\textwidth} p{.3\textwidth}}
    ...
    {\bf Health Card \#}: & - & {\bf Specimen \#}: & 24C-101GMOO14\\
  \end{tabular}
}}
...
{\bf \large Signed By}\\
Andrea Vaags, PhD FCCMG on 10/04/24

\vspace{2em}
\rule{\textwidth}{1pt}\\
{\small Blood specimen 24C-101GMO014 from Blood, Venous Unspecified. Ordered by Andrea Vaags, PhD FCCMG. Authorized by Andrea Vaags, PhD FCCMG. Collected: 10/4/2024 1158, Received: 1158. Verified: 10/4/2024 1223. Resulted by Credit Valley Hospital Laboratory Molecular Diagnostics.}
