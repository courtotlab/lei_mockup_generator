...
\setlength{\headheight}{17.16962pt}
\addtolength{\topmargin}{-5.16962pt}
...
\begin{document}
\begin{tabular}{>{\centering \arraybackslash} p{10cm} >{\raggedleft\arraybackslash}p{6cm}}
\begin{tabular}[t]{@{}c@{}}
\vspace{1em}
{\huge\bf Ontario Cancer Hospital} \\
{\large 123 Main St. West, Toronto, ON, A4B5G9} \\
{\large info@och.on.ca | fax: 416-456-7890 | phone: 437-416-6470}
\end{tabular}
& {\Large Division of Tumor Sequencing and Diagnostics} 
\end{tabular}
\vspace{2em}
\hrule
...
\vspace{2em}
Reported - \data{date_verified} \\
\multicolumn{1}{c}{{\bf \Large Results:}} \\ 
\data{summary_blurb}
\end{tabular}
\end{tabular}
\vspace{2em}
...
\newline
\begin{tabular}{|p{2.5cm}|p{2cm}|p{2cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}p{2.5cm}}
{\bf \large Gene} & {\bf \large Exon} & {\bf \large Base} & {\bf \large Amino Acid} & {\bf \large Zygosity} & {\bf \large Interpretation} \\
\hline
\begin{dataiter}{variants}\data{gene_symbol} & \data{exon} & \data{hgvsc} & \data{hgvsp} & \data{zygosity} & \data{interpretation}\\ \hline
\end{dataiter}
\end{tabular}
\newline
\newline
