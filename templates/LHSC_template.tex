...
\end{tabular}
\\ \data{zygosity} unless otherwise indicated %or should we add a new column for zygosity
\end{dataiter}
...
\begin{dataiter}{tested_genes} \data{gene_symbol} (\data{refseq_mrna}),\end{dataiter}
\vspace{1em}
