...
\\ \\
Specimen Tested - \data{sample_type} \\ \\ %Lei struggle area will incorporate into paragraph so can delete here eventually
Sequencing Scope - \data{sequencing_scope} \\ \\
