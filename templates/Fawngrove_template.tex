...
{\bf Sample Type}: Blood & {\bf Date Requested}: \data{date_collected} & Hereditary Breast \& Ovarian Cancer Testing \\
...
\begin{dataiter}{variants}\data{gene_symbol} & \data{hgvsc} (\data{hgvsp}) & \data{interpretation} \\
\end{dataiter}
\end{tabular}
