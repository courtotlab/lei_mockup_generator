...
## Requirements:
R>=4.5, with the following packages installed: `argparser`, `biomaRt`, `hgvsParseR`, `httr`, `RJSONIO`, `yaml`

## Usage:
```bash
# generate 10 sets of mockup data
$ Rscript scripts/generate_mock_data.R --amount 10 --outfile mock_data.json
